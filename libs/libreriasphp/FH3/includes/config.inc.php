...
fh_conf( 'FH_CAPTCHA_LENGTH',9 );
// The width of a captcha image
fh_conf( 'FH_CAPTCHA_WIDTH',250 );
...
fh_conf('FH_DEFAULT_LANGUAGE', 'es');
...
fh_conf('FH_MIN_PASSWORD_LENGTH', 8);
...
fh_conf('FH_DEFAULT_LISTFIELD_SIZE', 5);
