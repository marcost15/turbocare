...
include './modelo/bd_buscar_morbilidad.php';
$_SESSION['ini']=parse_ini_file('./configs/config.ini',true);
if (bd_verificar_privilegios('consmod_morbilidad.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->borderStart('Consultar Morbilidad');
...
function procesar($d)
{
	global $smarty;
	$texto=$d['texto'];
	$datos15 = bd_buscar_morbilidad(2,$texto);
	if (isset($datos15))
	{
		$error1 = '2';
	}
