...
if (bd_verificar_privilegios('rp_frm_hhexfecha.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->borderStart('Informe Horas Hombre');
...
function procesar($d)
{
	...
	else
	{
		...
		ir("rp_cons_hhexfecha.php?fecha_ini=$fecha_ini&fecha_fin=$fecha_fin");
	}
}
