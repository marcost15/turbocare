<?php /* Smarty version 2.6.26, created on 2014-03-05 21:23:13
         compiled from rp_cons_morbilidadxseccion.html */ ?>
...
<table  class="enhancedtable" border="1" align="center" width="100%">
 <tr>
	...
	<th width = "60%"><FONT SIZE=10>Relacion de Morbilidad Turbo Care</th>
...
<p>
<div id = "indice">Relacion de Morbilidad Turbo Care </br>Seccion: <?php echo $this->_tpl_vars['secciones_morb_id']; ?>
 </div>
</p>
...
?>
	<tr>
		...
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['amezulia']; ?>
</td>
		...
		<td>&nbsp;</td>
		<?php endif; ?>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['consulta_ext']; ?>
</td>
		...
		<td>&nbsp;</td>
		<?php endif; ?>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['reposos_ac_ec']; ?>
</td>
		...
		<td>&nbsp;</td>
		<?php endif; ?>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['reposo_at_eo']; ?>
</td>
...
<p>
<div id="boton">
<a href="xls_morbilidadxseccion.php" target="_xls"><img onmouseover='overlib("<strong>Generar .xls</strong>",WIDTH, 70)' src="./imagenes/excel.png" width="50" height="50" onmouseout='return nd();'/></a>
<a href='./grafico_morbilidadxseccion.php' class='claseiframe'><img onmouseover='overlib("<strong>Generar Grafico</strong>",WIDTH, 70)' src="./imagenes/grafico.png" width="50" height="50" onmouseout='return nd();'/></a></div>
<p>
</div><?php endif; ?>
<div id="boton" align="center"><a href="rp_frm_morbilidadxseccion.php"><img onmouseover='overlib("<strong>Volver</strong>",WIDTH, 70)' src="./imagenes/flecha_izquierda.gif" onmouseout='return nd();'/></a></div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
