<?php /* Smarty version 2.6.26, created on 2014-03-04 12:05:20
         compiled from condiciones.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Condiciones de Incidencia')));
...
<thead>
<tr>
	<th colspan="2">CONDICIONES INCIDENTES</th>
</tr>
</thead>
<tbody>
<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['condiciones']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<tr>
	<td><?php echo $this->_tpl_vars['condiciones'][$this->_sections['i']['index']]['nombre']; ?>
</td>
	<td width="10%"><a href="?id=<?php echo $this->_tpl_vars['condiciones'][$this->_sections['i']['index']]['id']; ?>
