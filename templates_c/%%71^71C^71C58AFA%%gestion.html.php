<?php /* Smarty version 2.6.26, created on 2014-03-04 12:03:34
         compiled from gestion.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Tipos de Gestion')));
...
<thead>
<tr>
	<th colspan="2">TIPOS DE GESTION</th>
</tr>
</thead>
<tbody>
<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['gestion']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<tr>
	<td><?php echo $this->_tpl_vars['gestion'][$this->_sections['i']['index']]['nombre']; ?>
</td>
	<td width="10%"><a href="?id=<?php echo $this->_tpl_vars['gestion'][$this->_sections['i']['index']]['id']; ?>
