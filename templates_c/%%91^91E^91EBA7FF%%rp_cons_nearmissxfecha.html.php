<?php /* Smarty version 2.6.26, created on 2014-03-06 14:02:48
         compiled from rp_cons_nearmissxfecha.html */ ?>
...
<table  class="enhancedtable" border="1" align="center" width="100%">
 <tr>
	...
	<th width = "60%"><FONT SIZE=10>CONTROL NEAR MISS</th>
...
<p>
<div id = "indice">CONTROL DE NEAR MISS </br>Desde: <?php echo $this->_tpl_vars['fecha_ini']; ?>
 Hasta: <?php echo $this->_tpl_vars['fecha_fin']; ?>
 </div>
</p>
<?php if ($this->_tpl_vars['datos']): ?>
<div id="resultados">
<table class="enhancedtable" cellspacing="0" border="1" align="center" width="100%">
<thead>
	<tr> 
		<th>NRO</th>
...
<p>
<div id="boton">
<a href="xls_nearmissxfecha.php" target="_xls"><img onmouseover='overlib("<strong>Generar .xls</strong>",WIDTH, 70)' src="./imagenes/excel.png" width="50" height="50" onmouseout='return nd();'/></a>
<a href='./grafico_nearmissxfecha.php' class='claseiframe'><img onmouseover='overlib("<strong>Generar Grafico</strong>",WIDTH, 70)' src="./imagenes/grafico.png" width="50" height="50" onmouseout='return nd();'/></a></div>
<p>
</div><?php endif; ?>
<div id="boton" align="center"><a href="rp_frm_nearmissxfecha.php"><img onmouseover='overlib("<strong>Volver</strong>",WIDTH, 70)' src="./imagenes/flecha_izquierda.gif" onmouseout='return nd();'/></a></div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
