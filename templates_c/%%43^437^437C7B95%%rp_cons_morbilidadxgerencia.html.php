<?php /* Smarty version 2.6.26, created on 2014-03-05 21:22:25
         compiled from rp_cons_morbilidadxgerencia.html */ ?>
...
<p>
<div id = "indice">Relacion de Morbilidad Turbo Care </br>Gerencia: <?php echo $this->_tpl_vars['gerencia_id']; ?>
 </div>
</p>
...
<p>
<div id="boton">
<a href="xls_morbilidadxgerencia.php" target="_xls"><img onmouseover='overlib("<strong>Generar .xls</strong>",WIDTH, 70)' src="./imagenes/excel.png" width="50" height="50" onmouseout='return nd();'/></a>
<a href='./grafico_morbilidadxgerencia.php' class='claseiframe'><img onmouseover='overlib("<strong>Generar Grafico</strong>",WIDTH, 70)' src="./imagenes/grafico.png" width="50" height="50" onmouseout='return nd();'/></a></div>
<p>
</div><?php endif; ?>
<div id="boton" align="center"><a href="rp_frm_morbilidadxgerencia.php"><img onmouseover='overlib("<strong>Volver</strong>",WIDTH, 70)' src="./imagenes/flecha_izquierda.gif" onmouseout='return nd();'/></a></div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
