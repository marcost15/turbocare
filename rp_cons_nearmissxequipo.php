...
if (bd_verificar_privilegios('rp_cons_nearmissxequipo.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$reporte = sql2array("SELECT id,fecha,personal_id,equipo_id,area,hallazgos,acciones,correcciones,fecha_eva,evaluador_id,personal_rev_id,fecha_revi,observaciones,
							personal_obs_id,fecha_obs,status,tipo_gestion_id FROM informes WHERE equipo_id = '$id'");
...
$equipo_id = bd_obt_equipos(0,$_REQUEST['id']);
