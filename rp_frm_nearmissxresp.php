...
include './modelo/bd_buscar_informe.php';
$_SESSION['ini']=parse_ini_file('./configs/config.ini',true);
if (bd_verificar_privilegios('rp_frm_nearmissxresp.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->borderStart('Reporte por Responsable');
...
{
	$id = $d['personal_id'];
	ir("rp_cons_nearmissxresp.php?id=$id");
}
