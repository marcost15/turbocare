...
if (bd_verificar_privilegios('consmod_incidentes.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->borderStart('Consultar Incidentes');
...
function procesar($d)
{
	global $smarty;
	$texto=$d['texto'];
	$datos15 = bd_buscar_incidentes(2,$texto);
	if (isset($datos15))
	{
		$error1 = '2';
	}
